...
import { addItemToCart, removeItemFromCart, RemoveItemFromCart } from '../../actions/cartActions'
...
const Cart = () => {
    ...
    return (
        <Fragment>
            ...
            {cartItems.length === 0 ? <h2 className="mt-5">Your Cart is Empty! Add New Product.</h2> : (
                <Fragment>
